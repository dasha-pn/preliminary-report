...
To reduce unsprung mass, the wheel body uses a perforated web pattern. Preliminary 
finite-element analysis indicates the geometry satisfies loading up to \SI{45}{\kilo\gram}, 
